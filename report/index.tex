% !TeX root = index.tex
\documentclass[a4paper, 14pt]{report}   % general format
...
\setlength{\parindent}{0}       % we don't want any paragraph indentation
\setlength{\parskip}{0.5cm}     % space between the paragraphs
